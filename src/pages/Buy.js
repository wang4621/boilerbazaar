...
=======
var searchHistory = ["CS307", "CS252", "CS251"]
    ...
    inp.addEventListener("input", function(e) {
        ...
        for (i = 0; i < arr.length; i++) {
          ...
          if (arr[i].substr(0, val.length).toUpperCase() == val.toUpperCase()) {
            ...
            b.innerHTML += "<input background-color: rgb(233, 233, 233) type='hidden' value='" + arr[i] + "'>";
...
function Buy (){
    getSearchHistory();
    autocomplete(document.getElementById("input"), searchHistory);
    return (
        <body>
